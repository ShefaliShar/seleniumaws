...
app = 'Moodle'
admin_username = 'shefalisingla'
admin_password = 'Moodle!1234'
...
moodle_user_main_page = 'http://52.39.5.126/admin/user.php'
moodle_user_main_page_title = 'SQA: Administration: Users: Accounts: Browse list of users'
...
description = f'User added by {admin_username} via Python Selenium automated Test script.'  # or can generate fake.sentence(nb_words=100)
pic_desc = f'Picture submitted by {full_name}'
